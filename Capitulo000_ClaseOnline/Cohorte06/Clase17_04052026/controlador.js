...
/* Repasito rapido de funciones callBack */

/* Es una función en forma de arrow function
que calcula el importe con iva de un producto. 
es una función con nombre. fnPrecioConIva
*/

const fnPrecioConIva = (importeBase)=>{

  return (importeBase + importeBase * 21/100);

}

/* Esta función se denomina función de nivel
superior. función llamadora. */

const fnDeNivelSuperior = (fn,importe) => {

  let resultado = fn(importe);
...
{
  let resultado = fnDeNivelSuperior(fnPrecioConIva,100);

  let resultado2 = fnDeNivelSuperior((importe)=>{

    return importe * 3/100;
...
/* 
  ...
  TODOS ESTOS MÉTODOS SON FUNCIONES DE NIVEL SUPERIOR
  QUE NECESITAN PARA EJECUTARSE UNA FUNCIÓN CALLBACK A DENTRO
...
window.onload = ()=>{
  ...
  console.log(idBtnParticularidades,idBtnFuncCallBack,idBtnForEach,idBtnMap);
