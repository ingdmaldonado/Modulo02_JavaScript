...
window.onload = function () {
  ...
  idBoton1.onclick = () => {
    ...
    /* El mismo símbolo puede significar cosas distintas
       ...
       {} a la IZQUIERDA del = → estoy DESTRUCTURANDO un objeto */
              ...
              // creando un vector
       const Vector1 = ["LUCAS","FERNANDA","JUAN ANDRES","DANIEL"];

       // destructuring - descomponer un vector en partes //
       ...
       // Destructuring - descomponer en partes un objeto //

       let {dni,apellido,nombrecompleto} = datosSecretaria;
  ...
  idBoton2.onclick = () => {
    ...
    /* Forma tradicional: para acceder a las propiedades de un objeto
       ...
       console.log(datosSecretaria.nombrecompleto);
  ...
  idBoton3.onclick = () => {
    ...
    const empleado1 = {legajo:707,apellido:"LOPEZ JORGE"};
    ...
    /* 
      S.G.B.D. RELACIONALES => estructural, rigido y los mismos datos. 95%
      S.G.B. NO RELACIONALES => flexibilidad => MongoDB
   */
