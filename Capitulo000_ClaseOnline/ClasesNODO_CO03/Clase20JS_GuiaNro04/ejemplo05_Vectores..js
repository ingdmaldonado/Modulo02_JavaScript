...
/* 
EJERCICIO: Guia Nro. 04 - Ejercicio 13
    Dado un vector que contiene datos de clientes de una 
    empresa de servicios, cuyos atributos son dni, apellido,
    nombre, codigo postal. y otro vector donde están 
    todas las localidades con su nombre y cuyos atributos 
    son codigo postal y nombre de la localidad.
	Recorra el vector de clientes (usando forEach) 
    y para cada cliente, busque el nombre de la localidad 
    usando el método find() sobre el vector de localidades.
	La idea es mostrar todos los datos de los clientes, 
    incluyendo el código de la localidad 
    y el nombre de la localidad donde vive.
*/
