...
const { status, data: numeros } = response;
console.log(status);
console.log(numeros);
...
/*
(8) Destructuring con spread/rest (muy usado al clonar o separar propiedades)
*/
const usuario5 = {
  id: 101,
  nombre: "Carla",
...
const { id, ...restoDeDatos } = usuario5;
console.log(id);
console.log(restoDeDatos);

/*
Ejercicio:
Dado el siguiente objeto, extraé id y agrupá el resto de propiedades en una variable datosEmpleado. Mostrá ambos por consola.
*/
const empleado = {
  id: 202,
  nombre: "Carlos",
