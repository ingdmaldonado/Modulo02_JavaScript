...
export const cohorte01 = [
 { dni: "12345678", nombre: "Juan", apellido: "Pérez", nota_final: 8 }, /* el alumno es cada elemento/objeto del vector */
 { dni: "23456789", nombre: "Ana", apellido: "Gómez", nota_final: 6 }, /* dni, nombre, apellido, etc propiedades del objeto */
...
export const alumnos = [...cohorte01, ...cohorte02, ...cohorte03, ...cohorte04];

//Ejercicio Nº 3//

export const alumnosAprobados = alumnos.filter (alumnos  => alumnos.nota_final > 5);

export const alumnosDesaprobados = alumnos.filter (alumnos => alumnos.nota_final <= 5);

//Ejercicio Nº 4//

export const notasGenerales = alumnos.sort ((a,b) => a.nota_final - b.nota_final );

//Ejercicio Nº 5//

export const buscarAlumnoXDni = (dniBuscado) =>{
...
export const cantidadAprobadosIf = alumnos.reduce(
    (contador, alumno)=>{
...
export const cantidadAprobadosTernario = alumnos.reduce(
    (contador, alumno)=>
