...
export const mostrarAlumnos = (alumnos, numeroCohorte) => {
    numeroCohorte ? console.log(`Alumnos de la cohorte ${numeroCohorte}`) : "";
    alumnos.forEach(({nombre, apellido}) => console.log(nombre, apellido));
}