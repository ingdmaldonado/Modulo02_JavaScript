...
import {obtenerAprobados} from "./3modelo.js";
import {obtenerDesaprobados} from "./3modelo.js";
...
idBtnMostrar.onclick = () => {const alumnosTotales = [...cohorte01,...cohorte02,...cohorte03,...cohorte04];

const alumnosAprobados = obtenerAprobados(alumnosTotales);

const alumnosDesaprobados = obtenerDesaprobados(alumnosTotales);
