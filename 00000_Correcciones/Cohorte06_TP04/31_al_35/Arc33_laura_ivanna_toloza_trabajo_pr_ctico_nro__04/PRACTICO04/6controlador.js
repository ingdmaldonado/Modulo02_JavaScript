...
import { aprobadosIf } from "./6modelo.js";
import { aprobadosTernario } from "./6modelo.js";
...
const alumnosTotales = [...cohorte01,...cohorte02,...cohorte03,...cohorte04];
const totalIF = aprobadosIf(alumnosTotales);
const totalTernario = aprobadosTernario(alumnosTotales);

console.log(`Total aprobados if: ${totalIF}`);

console.log(`Total aprobados ternario: ${totalTernario}`);
};