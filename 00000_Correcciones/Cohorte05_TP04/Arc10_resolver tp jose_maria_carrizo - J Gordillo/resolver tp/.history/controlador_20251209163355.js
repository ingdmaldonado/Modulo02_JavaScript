...
document.addEventListener("DOMContentLoaded", () => {
  ...
  btnFiltros.addEventListener("click", () => {
    ...
    console.log("Aprobados (nota > 5):", aprobados);
    console.log("Desaprobados (nota <= 5):", desaprobados);

    fnMostrarEnPantalla("Aprobados y desaprobados (nota > 5):", {
      aprobados,
      desaprobados
    });
  });
  ...
  btnContar.addEventListener("click", () => {
    ...
    const mensaje =
      `Aprobados (reduce + if/else, nota > 5): ${cantIf}\n` +
      `Aprobados (reduce + ternario, nota > 5): ${cantTernario}`;
