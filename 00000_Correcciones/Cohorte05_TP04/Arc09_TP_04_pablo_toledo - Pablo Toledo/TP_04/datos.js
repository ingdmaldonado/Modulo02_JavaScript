...
{id: 1,detalle: "Item 1 - Mostrar Apellido y Nombre de Cada Cohorte"},
{id: 2,detalle: "Item 2 - Unificar Cohortes"},
{id: 3,detalle: "Item 3 - Listar Aprobados"},
{id: 4,detalle: "Item 3 - Listar Desaprobados"},
{id: 5,detalle: "Item 4 - Ordenar Alumons por Nota"},
{id: 6,detalle: "Item 5 - Buscar Alumno por DNI"},
{id: 7,detalle: "Item 6 - Contar Alumons Aprobados"}
];

export const cohortes = [
{id:cohorte01,nombre:"Cohorte 01"},
{id:cohorte02,nombre: "Cohorte 02"},
{id:cohorte03 ,nombre:"Cohorte 03"},
{id:cohorte04,nombre: "Cohorte 04"}
];