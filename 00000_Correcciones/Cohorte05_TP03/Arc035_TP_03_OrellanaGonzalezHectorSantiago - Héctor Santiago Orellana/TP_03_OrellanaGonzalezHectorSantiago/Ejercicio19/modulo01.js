...
export const fnfacturaDeServicioPublicos=(importeBaseDeFactura)=>
    {
        let tasaDeficalizacion=0;
        tasaDeficalizacion=(importeBaseDeFactura * 1.2) /100;

        return tasaDeficalizacion;
    }
