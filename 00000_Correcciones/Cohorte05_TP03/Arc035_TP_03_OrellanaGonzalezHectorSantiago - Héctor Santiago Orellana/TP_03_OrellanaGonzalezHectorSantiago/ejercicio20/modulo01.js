...
export const fndosisDeInsulina=(NivelDeGlucosa,PesoCorporal,TipodeDiabetes) =>

    /* aqui realizo el calculo para la  deabetes tipo1*/
    {
        let dosisInsulina=0;
        ...
        if (TipodeDiabetes ===1)

            {
                ...
                dosisInsulina= dosisInsulina + (NivelDeGlucosa*50)/100;

            }

      /* aqui voy a realizar el calculo para la deabetes tipo2*/       
