 console.log(`Trabajo Practico #3`);
 console.log(`-------------------`);


//FUNCIONES IMPORTADAS DEL MODULO.JS

import { precioVenta } from "./modulo.js";
import { calificacionPromedio } from "./modulo.js";
import { esAprobadoONo } from "./modulo.js";
import { impuestoBebidas } from "./modulo.js";
import { calcularImporteAgua } from "./modulo.js";
import { calcularImporteAguaVersionProfe } from "./modulo.js";
import { facturaAguasCat } from "./modulo.js"; 
import { aguasCatFiscENRE } from "./modulo.js";
import { dosisInsulina } from "./modulo.js";
import { contadorVocales } from "./modulo.js";
import { contadorDeConsonantes } from "./modulo.js";
import { contadorLetrasS } from "./modulo.js";
import { contadorEspacios } from "./modulo.js";
import { cadenaSinNumeros } from "./modulo.js";
...

{
    ...
    */
        ...
        let ej13DevPrecioVenta = precioVenta(10000,10); //(importeCompra, margenGanancia)

        console.log(`Precio de venta final: $${ej13DevPrecioVenta}`);
    ...
    */
        ...
        let ej14CalcNotaPromedio = calificacionPromedio(5, 3, 4); //(nota1, nota2, nota3)

        console.log(`El promedio de calificación es: ${ej14CalcNotaPromedio}`);
    ...
    */
        ...
        let ej15TipoDeCalificacion = esAprobadoONo(5); //(Nota promedio)

        console.log(`Calificacion promedio: ${ej15TipoDeCalificacion}`);
    ...
    */
        ...
        let ej16ImpuestoBebidas = impuestoBebidas(10000,2); //(importeBase, tipoDeBebida), [1-Agua Pl,2-Agua Ret,3-Gaseosa Pl, 4-Gaseosa Ret, 5-Energizante]

        console.log(`Sobretasa: ${ej16ImpuestoBebidas}`);
...
*/
    ...
    let ej17ImporteAguaCalculado = calcularImporteAgua("79");//(metrosCubicos)

    console.log(`Importe del bloque actual: $${ej17ImporteAguaCalculado}`);


    //Version profe

    let ej17importeAguaCalculadoV2 = calcularImporteAguaVersionProfe(68);//(metrosCubicos)

    console.log(`Version del profe: $${ej17importeAguaCalculadoV2}`);
...
*/
    ...
    let ej18TasaSubsueloAguasCat = facturaAguasCat(1000); //(importeBase)

    console.log(`Tasa subsuelo (3%) del importe ingresado: $${ej18TasaSubsueloAguasCat}`);
...
*/
    ...
    let ej19FiscEnreAguasCat = aguasCatFiscENRE("1000"); //(importeBase)

    console.log(`Tasa de Fiscalización ENRE (1.2%) del importe ingresado: $${ej19FiscEnreAguasCat}`);
...
*/
    ...
    let ej20dosisInsulina = dosisInsulina(100, 95, 2);//(glucosa, peso, tipoDiabetes)

    console.log(`Dosis de insulina: ${ej20dosisInsulina}`);
}
...
*/
    ...
    let ej21contarVocales = contadorVocales("Trabajo Practico 3, Jorge Luis Alejandro Vera");//(cadenaTexto)

    console.log(`cantidad de vocales: ${ej21contarVocales}`);
...
*/
    ...
    let ej22contarConsonantes = contadorDeConsonantes("Trabajo Practico 3, Jorge Luis Alejandro Vera");//(cadenaTexto)

    console.log(`cantidad de consonantes: ${ej22contarConsonantes}`);
...
*/
    ...
    let ej23contadorLetrasS = contadorLetrasS("resuelto");//(texto)

    console.log(`Contiene al menos dos letras "s"?: ${ej23contadorLetrasS}`);
...
*/
    ...
    let ej24contadorEspacios = contadorEspacios("tres espacios en blanco"); //(texto)

    console.log(`Contriene al menos tres espacios? : ${ej24contadorEspacios}`);
...
*/
    ...
    let ej25cadenaSinNumeros = cadenaSinNumeros("trabajo practico");//(texto)

    console.log(`Contiene numeros? : ${ej25cadenaSinNumeros}`);