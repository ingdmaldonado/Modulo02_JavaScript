...
export const calcular_Tasa = (tipo_Bebida, importe_Base) => {
    let tasa = 0;
    switch (tipo_Bebida) {
        case 1: tasa = (importe_Base * 5) / 1000
        break;
        case 2: tasa = (importe_Base * 1) / 1000;
        break;
        case 3: tasa = (importe_Base * 7) / 1000;
        break;
        case 4: tasa = (importe_Base * 2) / 1000;
        break;
        case 5: tasa = (importe_Base * 1) / 1000;
        break;
        case 6: tasa = (importe_Base * 1) / 1000; 
        break;
        default: console.log("INGRESO UN VALOR INCORRECTO"); 
        break;
    }
    return tasa;
}
