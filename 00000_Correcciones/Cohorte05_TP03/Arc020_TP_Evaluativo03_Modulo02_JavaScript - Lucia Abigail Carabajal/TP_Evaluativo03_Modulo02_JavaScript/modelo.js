...
export const evaluaPromedio = (nota)=>{
...
55             (50 × 350,00) + (20 × 555,20)                       20.276,00  
...
export const calcularImporteBaseAgua = (mtsCubicos)=>{
    ...
    if (mtsCubicos <= 70) // bloque 1 y bloque 2
    {
        ...
        importeBloque2 = (mtsCubicos - 50) * 350.00;
    }

    if (mtsCubicos <= 85) // bloque 3
    {
        importeBloque1 = 50 * 350.00 + 20 * 555.20 + 15 * 1.552,20;
    }
...
export const calcularTasaSubsuelo = (importeBase)=> importeBase * 0.03;
...
export const calcularTasaENRE = (importeBase)=> importeBase * 0.012;
...
Nota: Debe devolver un número.
*/
export const contarVocales = (cadenaDeTexto)=>{
    ...
    {
        const caracter = cadenaDeTexto[i];
...
Nota: Debe devolver un número.
*/
export const contarConsonantes = (cadenaDeTexto)=>{
...
export const tieneTresEspacios = (cadenaDeTexto)=>{
