...
// Valores de prueba
const consumo1 = 30;  // ejemplo del enunciado
const consumo2 = 55;
const consumo3 = 85;

console.log("Consumo 30 m³ → ", calcularImporteAgua(consumo1));
console.log("Consumo 55 m³ → ", calcularImporteAgua(consumo2));
console.log("Consumo 85 m³ → ", calcularImporteAgua(consumo3));