...

{
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    descartes ++; // toma el valor de la variable y la incrementa en 1
                }                    
            }    
        }
    ...
    /* Parte 03: Al salir de la carga y registración
    de todos los huevos */

    let totalHuevos = cantidadM + cantidadL + cantidadXL + descartes;

    /* ESTRUCTURAS QUE TENGO
    
        - CONDICIONALES
        - CICLOS REPETITIOS

        COMPORTAMIENTOS O PATRONES QUE SE REPITEN 
    ...
    */
    ...
    console.log(`No se ingresaron huevos`);
}
}
