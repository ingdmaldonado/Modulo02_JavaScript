...
// variable para controlar si sigue cargando
let continuar = true;

while (continuar === true) {
    // pedir la nota al usuario
    let notaTexto = prompt("Ingrese la nota del trabajo final:");

    // si el usuario presiona cancelar, cerrar el programa
    if (notaTexto === null) {
        continuar = false;
        break;
    }
    ...
    // validar si la nota es incorrecta (menor a 0 o mayor a 10)
    if (nota < 0 || nota > 10) {
        errores = errores + 1;
    ...
    let respuesta = prompt("¿Desea continuar cargando notas? (s/n)");
...
console.log("Resultados de los trabajos finales:");
