...
conectarme a un endPoint de una Api

API => Conjunto de todos los endPoint
    que expone una empresa, organizacion, 
    la web.
...
export const fnRequestAPI = async (URL) =>{
    ...
    try {
        ...
        throw new Error (`Erorr en Api.js - se produjo un error ${error.message}`);
    }
