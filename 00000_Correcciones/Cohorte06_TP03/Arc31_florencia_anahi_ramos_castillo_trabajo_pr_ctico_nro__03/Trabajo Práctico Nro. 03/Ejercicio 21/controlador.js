import {fnCalcularPromedio,fnEvaluarNota} from "./modelo.js";
...
window.onload = ()=>{
    ...
    idBtnEvaluar.onclick = ()=>{
        ...
        let promedio = fnCalcularPromedio(
            estadoAplicacion.nota1,
            estadoAplicacion.nota2,
            estadoAplicacion.nota3
        );

        let resultado = fnEvaluarNota(promedio);

        console.log(promedio);

        console.log(resultado);

        idResultado.textContent = `Promedio ${promedio} - Resultado ${resultado}`;
