import {fnContarVocales} from "./modelo27.js"
...
window.onload = ()=>{
    ...
    idBtnCalcular.onclick = ()=>{
        ...
        let resultado = fnContarVocales(estadoAplicacion.cadenaTexto);

        // aqui muestro en el DOM en cualquier etiqueta que me permita mostrar texto
        idResultado.textContent = `Cadena de texto ingresada: "${estadoAplicacion.cadenaTexto}" - Cantidad de vocales: ${resultado}`;
