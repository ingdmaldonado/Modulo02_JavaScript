...
window.onload = ()=>{
    ...
    idBtnCalcular.onclick = ()=>{
        ...
        let resultado = fnContarConsonantes(estadoAplicacion.cadenaTexto);

        // aqui muestro en el DOM en cualquier etiqueta que me permita mostrar texto
        idResultado.textContent = `Cadena de texto ingresada: "${estadoAplicacion.cadenaTexto}" - Cantidad de Consonantes: ${resultado}`;
