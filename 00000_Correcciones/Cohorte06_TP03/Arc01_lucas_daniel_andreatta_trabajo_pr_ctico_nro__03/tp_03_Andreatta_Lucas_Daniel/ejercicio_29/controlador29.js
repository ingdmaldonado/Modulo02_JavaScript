import {fnComprobarLetraS} from "./modelo29.js"
...
window.onload = ()=>{
    ...
    idBtnCalcular.onclick = ()=>{
        ...
        let resultado = fnComprobarLetraS(estadoAplicacion.cadenaTexto);

        // aqui muestro en el DOM en cualquier etiqueta que me permita mostrar texto
        idResultado.textContent = `Palabra ingresada: "${estadoAplicacion.cadenaTexto}" - Se cumple que la palabra tenga al menos dos "s"/"S"? : ${resultado}`;
