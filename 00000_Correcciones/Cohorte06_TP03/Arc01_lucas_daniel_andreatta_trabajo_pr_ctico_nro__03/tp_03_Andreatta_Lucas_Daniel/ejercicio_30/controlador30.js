import {fnContarEspaciosBlancos} from "./modelo30.js"
...
window.onload = ()=>{
    ...
    idBtnCalcular.onclick = ()=>{
        ...
        let resultado = fnContarEspaciosBlancos(estadoAplicacion.cadenaTexto);

        // aqui muestro en el DOM en cualquier etiqueta que me permita mostrar texto
        idResultado.textContent = `Cadena de texto ingresada: "${estadoAplicacion.cadenaTexto}" - Contiene 3 espacios en blanco?: ${resultado}`;
