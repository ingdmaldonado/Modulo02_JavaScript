import {verificarLetra} from "./modelo.js"
...
window.onload = () => {
    ...
    botonCalcular.onclick = () => {
        if(cadena.value.length > 0){
            resultado.textContent = `El mensaje tiene ${verificarLetra(estadoAplicacion.cadena.toLowerCase()) ? "dos o más" : "menos de dos"} letras S`;
        }
        else
        {
