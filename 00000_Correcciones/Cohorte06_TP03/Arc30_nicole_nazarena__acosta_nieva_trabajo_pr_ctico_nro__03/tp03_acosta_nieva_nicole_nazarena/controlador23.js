...
Una empresa de distribución de agua potable "Aguas de Catamarca ECSAPEM" utiliza un esquema de facturación por bloques de consumo,
 donde el precio por metro cúbico aumenta a medida que el usuario consume más. 
 Este tipo de sistema se aplica con el objetivo de promover el uso responsable del recurso y penalizar el consumo excesivo.
...
metros cúbicos, es decir desde el metro cúbico número 51 hasta el 70,
...
idBtnCalcular.onclick = () => {
    ...
    idResultado.textContent = `El importe a pagar es:${resultado.toFixed(2)}`
};
};
