...
import { fnCantidadEspacios } from "./modelo30.js";
import { fnGuardar } from "./modelo30.js";
import { fnRecuperar } from "./modelo30.js";
...
window.onload = () => {
    ...
    idBtnCalcular.onclick = () => {
        let resultado = fnCantidadEspacios(estadoAplicacion.texto);
        idResultado.textContent = `Hay mas de 3 espacios en el texto: ${resultado} `
    };
