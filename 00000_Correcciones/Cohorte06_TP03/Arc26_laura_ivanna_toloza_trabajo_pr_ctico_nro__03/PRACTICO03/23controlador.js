...
El cálculo del importe base se realiza a partir de los metros cúbicos leídos en el medidor del cliente. Para ello, la empresa define 
tres bloques de facturación. El primer bloque corresponde a los primeros 50 metros cúbicos, que se facturan a razón de 350 pesos por metro cúbico. 
El segundo bloque comprende los siguientes 20 metros cúbicos, es decir desde el metro cúbico número 51 hasta el 70, 
los cuales se facturan a un valor de 555,20 pesos por metro cúbico. Finalmente, todo consumo que supere los 70 metros cúbicos 
se considera dentro del bloque excedente o de castigo, y se factura a razón de 1.552,20 pesos por metro cúbico.
...
import {calcularImporteAgua} from "./23modelo.js";
...
idBtnCalcular.onclick = () => {
    ...
    estadoAplicacion.importeAgua = resultado;
    idResultado.textContent = `El importe base es: $ ${resultado.toFixed(2)}`;
};
...
idBtnRecuperar.onclick = () => {
    ...
    estadoAplicacion.metrosCubicos = datosObjeto.metrosCubicos;
    estadoAplicacion.importeAgua = datosObjeto.importeAgua;
    idMetros.value = estadoAplicacion.metrosCubicos;

    idResultado.textContent = `El importe base es: $ ${estadoAplicacion.importeAgua.toFixed(2)}`;
};