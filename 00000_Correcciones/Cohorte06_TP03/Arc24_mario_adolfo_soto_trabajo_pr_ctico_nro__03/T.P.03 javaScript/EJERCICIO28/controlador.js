import {fnCantidadDeVocales} from "./modelo.js"
...
window.onload = ()=>{
    ...
    btncalcular.onclick =()=>{
        let cadenaDeTexto1 = fnCantidadDeVocales(estaddoAplicacion.texto) ; 
        resultado.textContent =`la cantidad de consonantes es ${cadenaDeTexto1}`;
