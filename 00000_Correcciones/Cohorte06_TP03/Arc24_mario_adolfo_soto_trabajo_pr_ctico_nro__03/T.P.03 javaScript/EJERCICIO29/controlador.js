import {fnCantidadLetraS} from "./modelo.js"
...
window.onload = ()=>{
    ...
    btncalcular.onclick =()=>{
        let cadenaDeTexto1 = fnCantidadLetraS(estaddoAplicacion.texto) ; 
        resultado.textContent =`la cantidad de letras "s" es ${cadenaDeTexto1}`;
