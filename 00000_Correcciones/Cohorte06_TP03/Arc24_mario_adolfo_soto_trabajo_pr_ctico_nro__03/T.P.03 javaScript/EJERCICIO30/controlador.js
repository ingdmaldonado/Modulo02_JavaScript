import {fnEspaciosEnBlanco} from "./modelo.js"
...
window.onload = ()=>{
    ...
    btncalcular.onclick =()=>{
        let cadenaDeTexto1 = fnEspaciosEnBlanco(estaddoAplicacion.texto) ; 
        resultado.textContent =`la cantidad de espacios en blanco es ${cadenaDeTexto1}`;
