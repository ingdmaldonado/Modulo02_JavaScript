...
window.onload = () => {
    ...
    idBtnCalcular.onclick = () => {
        let importe = calcularImporteAgua(estadoAplicacion.metrosCubicos);

        idResultado.textContent = `Importe Base:$` + importe;
    }
    ...
    idBtnRecuperar.onclick = () => {
        ...
        idMetrosCubicos.value = datosObjeto.metrosCubicos;
    };
