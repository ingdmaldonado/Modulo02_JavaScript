...
cantidad = Number(prompt(`Ingrese la cantidad de producto que desea:`));

if(codigo === 1 && cantidad < 5 ){
    precio = 38000;
    total = precio*cantidad;
}else if(codigo === 1 && cantidad >=5 && cantidad <= 10){
    precio = 36000;
    total = precio*cantidad;
}else if(codigo === 1 && cantidad >= 11){
    precio = 34000
    total = precio*cantidad;
}else if(codigo === 2 && cantidad < 5 ){
    precio = 31000;
    total = precio*cantidad;
}else if(codigo === 2 && cantidad >=5 && cantidad <= 10){
    precio = 29000;
    total = precio*cantidad;
}else if(codigo === 2 && cantidad >= 11){
    precio = 27000
    total = precio*cantidad;
} else if(codigo === 3 && cantidad < 5 ){
    precio = 46000;
    total = precio*cantidad;
}else if(codigo === 3 && cantidad >=5 && cantidad <= 10){
    precio = 44000;
    total = precio*cantidad;
}else if(codigo === 3 && cantidad >= 11){
    precio = 42000
    total = precio*cantidad;
} else{
