...
let importePasaje= Number(prompt("ingrese el importe del pasaje:"));
...
console.log(`usted compro ${cantidadPasajes} pasajes, el importe del pasaje es ${importePasaje}, el total de la compra es ${totalCompra}, el descuento aplicado es ${descuento} y el total a pagar es ${totalFinal}`);