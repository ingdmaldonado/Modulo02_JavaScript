...
if (edad >= 0 && edad <= 12) {
    console.log(`La persona es un niño de ${edad} años.`);
} else if (edad >= 13 && edad <= 17) {
    console.log(`La persona es un adolescente de ${edad} años.`);
} else if (edad >= 18 && edad <= 64) {
    console.log(`La persona es un adulto de ${edad} años.`);
} else if (edad > 64) {
    console.log(`La persona es un adulto mayor de ${edad} años.`);
} else {
