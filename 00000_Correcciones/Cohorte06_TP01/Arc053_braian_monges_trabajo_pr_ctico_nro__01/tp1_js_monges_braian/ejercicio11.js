...
{
    let importeDeCompra = Number(prompt(`ingrese importe de compra`));

    let envio = Number(prompt(`seleccione zona: 1 - zona centro; 2 - zona oeste; 3 - zona norte; 4 - zona sur; 5 - zona este`));
    ...
    totalAPagar = importeDeCompra + costoEnvio;
